...
def main():
    ...
    penn = cv2.imread("C:\\Users\\kevin\\OneDrive\\Desktop\\for student\\data\\barcelona\\images\\logos\\penn_logo.jpeg")
    ...
    img_files = sorted(glob.glob("C:\\Users\\kevin\\OneDrive\\Desktop\\for student\\data\\barcelona\\images\\barca_real\\*.png"))
    goal_data = np.load("C:\\Users\\kevin\\OneDrive\\Desktop\\for student\\data\\barcelona\\BarcaReal_pts.npy")
